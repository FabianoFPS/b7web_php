...
if (ENVIRONMENT == 'development'){
    ...
    define('BASE_URL', 'https://localhost/b7web_php/Modulo16-PHP_super_avancado/11e12-MVC-classificados/');
    //define ('PASTA_BASE', '/b7web_php/Modulo16-PHP_super_avancado/MVC/');
    define ('PASTA_BASE', '/b7web_php/Modulo16-PHP_super_avancado/11e12-MVC-classificados/');
